    ...
    : IdentityDbContext<User, IdentityRole<long>, long>(options)
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cart.Models.Cart>().OwnsOne(c => c.Client).OwnsOne(c => c.Address).HasData(
            new { ClientCartId = "CART00000001", Number = 123, Street = "Calle Falsa", City = "Soria", Province = "Soria", Country = "España", PostalCode = 42001 },
            new { ClientCartId = "CART00000002", Number = 123, Street = "Calle Falsa", City = "Soria", Province = "Soria", Country = "España", PostalCode = 42001 }
        );
