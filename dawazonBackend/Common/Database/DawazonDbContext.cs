    ...
    : IdentityDbContext<User, IdentityRole<long>, long>(options)
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new { Id = "PRD000000006", Name = "Funko Pop Hulk", Price = 18.00, Stock = 25, Description = "Figura Funko Pop de Hulk de Marvel.", CreatorId = 1L, CategoryId = "FIG000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/hulk_funko.jpg" } },
            new { Id = "PRD000000007", Name = "Batman Comic #50", Price = 7.50, Stock = 60, Description = "Edición especial del comic de Batman.", CreatorId = 1L, CategoryId = "COM000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/batman_50.jpg" } },
            new { Id = "PRD000000008", Name = "X-Men Comic #10", Price = 8.25, Stock = 12, Description = "Comic de los X-Men, número 10.", CreatorId = 1L, CategoryId = "COM000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/xmen_10.jpg" } },
            new { Id = "PRD000000009", Name = "Watchmen", Price = 25.00, Stock = 10, Description = "La aclamada novela gráfica Watchmen.", CreatorId = 1L, CategoryId = "COM000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/watchmen.jpg" } },
            new { Id = "PRD000000010", Name = "Black Widow Hoodie", Price = 35.99, Stock = 18, Description = "Sudadera de la Viuda Negra.", CreatorId = 1L, CategoryId = "ROP000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/widow_hoodie.jpg" } },
            new { Id = "PRD000000011", Name = "Thor Logo Cap", Price = 12.00, Stock = 45, Description = "Gorra con el logo de Thor.", CreatorId = 1L, CategoryId = "ROP000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/thor_cap.jpg" } },
            new { Id = "PRD000000012", Name = "Hulk Gloves", Price = 22.50, Stock = 20, Description = "Guantes gigantes de Hulk.", CreatorId = 1L, CategoryId = "ROP000000001", IsDeleted = false, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Version = 1L, Images = new List<string> { "/uploads/products/hulk_gloves.jpg" } },
